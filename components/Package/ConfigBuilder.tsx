...
const KEY_COMMANDS = [
    ...
    { label: 'line-height', value: 'line-height', icon: 'ph-text-align-justify' },
    ...
    { label: 'z-index', value: 'z-index', icon: 'ph-stack' },
    { label: 'overflow', value: 'overflow', icon: 'ph-selection' },
    { label: 'cursor', value: 'cursor', icon: 'ph-hand-pointing' },
    { label: 'user-select', value: 'user-select', icon: 'ph-cursor-text' },
    { label: 'pointer-events', value: 'pointer-events', icon: 'ph-fingerprint' },
];
...
const PROPERTY_VALUE_MAP: Record<string, { label: string; value: string; icon: string }[]> = {
    ...
    'overflow': [
        ...
        { label: 'auto', value: 'auto', icon: 'ph-magic-wand' },
        { label: 'clip', value: 'clip', icon: 'ph-scissors' },
    ],
    'cursor': [
    ...
    'user-select': [
        { label: 'none', value: 'none', icon: 'ph-prohibit' },
        { label: 'auto', value: 'auto', icon: 'ph-magic-wand' },
        { label: 'text', value: 'text', icon: 'ph-cursor-text' },
        { label: 'all', value: 'all', icon: 'ph-selection-all' },
    ],
    'pointer-events': [
        { label: 'auto', value: 'auto', icon: 'ph-magic-wand' },
        { label: 'none', value: 'none', icon: 'ph-prohibit' },
